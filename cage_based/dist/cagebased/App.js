...
function getBaryCoord(P_coords) {
    ...
    var b_coords = cageVertices[1];
    var c_coords = cageVertices[2];
...
*/
function meanValCoordinates(cageCoords, pointCoord) {
