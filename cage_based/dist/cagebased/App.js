...
import { vertexShaderSource, fragmentShaderSource, vertexShaderCage, fragmentShaderCage } from "./Shaders.js";
...
export class CageAnimation extends CanvasAnimation {
    ...
    initModel() {
        ...
        this.sceneRenderPass.addUniform("screenSize", (gl, loc) => {
            gl.uniform2f(loc, this.canvas2d.width, this.canvas2d.height);
        });
        this.sceneRenderPass.addAttribute("spritePosition", 2, this.ctx.FLOAT, false, 0, 0, undefined, array);
    ...
    initCage() {
        ...
        this.cageRenderPass.addUniform("screenSize", (gl, loc) => {
            gl.uniform2f(loc, this.canvas2d.width, this.canvas2d.height);
        });
        this.cageRenderPass.addAttribute("spritePosition", 2, this.ctx.FLOAT, false, 0, 0, undefined, array);
...
export function initializeCanvas() {
    ...
    /* Start drawing */
    const canvasAnimation = new CageAnimation(canvas);
